# arrow x coordinate
axc = 2.33412
# arrow tail x coordinate
atyc = 0.664099
# arrow head x coordinate
ahyc = 0.541

set arrow 1 from axc, atyc to axc, ahyc head filled size screen 0.02,15 lw 2 lc rgb "black" front
...
#: tics
set ytics 0.0, 0.028 nomirror
set xtics 0.0, 0.012 nomirror
