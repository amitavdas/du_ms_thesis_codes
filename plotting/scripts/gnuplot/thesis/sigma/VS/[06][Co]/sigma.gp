set arrow 1 from 2.39496,0.739044 to 2.39496,0.621 head filled size screen 0.02,15 lw 2 lc rgb "black" front
...
#: tics
set ytics 0.0, 0.032 nomirror
set xtics 0.0, 0.016 nomirror
