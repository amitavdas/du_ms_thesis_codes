...
set style line 11 dt (5 ,  5) pt 1  lw 3 lc "black"
set style line 12 dt (10 , 5) pt 4  lw 3 lc "black"
set style line 13 dt (15 , 5) pt 6  lw 3 lc "black"
set style line 14 dt (20,  5) pt 8  lw 3 lc "black"
set style line 15 dt (5 , 5 ) pt 10 lw 3 lc "black"
set style line 16 dt (5 , 10) pt 2  lw 3 lc "black"
set style line 17 dt (5 , 15) pt 14 lw 3 lc "black"
set style line 18 dt (5 , 20) pt 12 lw 3 lc "black"
...
#set style line 15 dt (5,  3, 5, 3, 15, 3)           lw l_w lc "black"
#set style line 16 dt (30, 3, 15, 3, 5, 3)           lw l_w lc "black"
#set style line 17 dt (30, 10)                       lw l_w lc "black"
#set style line 18 dt (10,  3, 10, 3, 10, 3, 10, 20) lw l_w lc "black"
                        
set key left offset 3, 0 samplen 10 font "Times New Roman,14pt"

set xlabel "time, {/Times-Italic t} (ps)" font "Times New Roman,14pt"
set ylabel "Mean Squared Displacement ({\305}^{2})" font "Times New Roman,14pt"
