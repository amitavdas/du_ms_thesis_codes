bs_r_c_data = '../../data/miscellaneous/bs_a.dat'
...
set ytics -0.132, 0.044 font "Times New Roman,12pt"
set ytics nomirror
set mytics 2
...
plot bs_r_c_data u 1:2  w l ls 11 title "{R_c}/a = 5.0",   \
              '' u 3:4  w l ls 12 title "{R_c}/a = 4.5",   \
              '' u 5:6  w l ls 13 title "{R_c}/a = 4.0"
